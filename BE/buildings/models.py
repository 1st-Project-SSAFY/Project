...
class Building_Floor(models.Model):
    # 건물_층 PK
    building_floor = models.CharField(max_length=20, unique=True)
    # 건물 id FK
    ...
    # 해당 층수 도면 이미지 경로
    img = models.ImageField(upload_to='home/ubuntu/file_data/building_images/', null=True)
...
class Sprinkler(models.Model):
    # 스프링클러 아이디
    sprinkler_id = models.CharField(max_length=30, unique=True)
    # 건물_층 FK
    building_floor = models.ForeignKey(Building_Floor, on_delete=models.CASCADE)
    # 스프링클러 설치 x 좌표
